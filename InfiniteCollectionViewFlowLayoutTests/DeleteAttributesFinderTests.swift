...
class DeleteAttributesFinderTests: XCTestCase {
    ...
    private lazy var sut = DeleteAttributesFinder(
    ...
    func test_WhenDeleteOneItemFromRowContainingThreeElements_CalculationResultShouldBeDefined() throws {
    ...
    private func completeAttributesAfterDelete(
        rowSpacing: CGFloat,
        cache: Cache,
